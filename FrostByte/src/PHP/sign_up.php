...
<head>
    ...
    <link rel="stylesheet" href="/FrostByte/src/css/sign_up.css">
...
<body>
    <main>
        ...
        <div id="right">
            ...
            <div id="body">
                ...
                <p id="sign-up-btn">Already have an account? <a href="/FrostByte/src/PHP/index.php">sign in</a></p>
        </form>
        </div>
    </main>
    <footer>
    ...
    <script>
        ...
        if (typeof toastr !== 'undefined') {
            ...
            console.log('Toastr configured on signup page');
        }
    </script>
    <script src="/FrostByte/src/js/auth/signup.js"></script>
</body>
</html>
